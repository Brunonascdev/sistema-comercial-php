...
<main class="main">
        ...
        <section class="twitter">
          <div class="containerDois"> 
              <h1 class="titulo">Usuário de código <?php echo $cod; ?> alterado com sucesso!</h1>              
                <button class="btns" type="reset" onclick="javascript: location.href='consultaUsuario.php'" style="width: 80%; margin-left: 10%;"> Voltar</button> 
          </div>
        </section>
      </main>
</body>
