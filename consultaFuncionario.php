...
<main class="main">
        ...
        <section class="twitter">
          <div class="containerDois">
            ...
            try
            {
                $select = $con->prepare('SELECT * FROM tb_funcionario');
                $select -> execute();

                while($linha = $select -> fetch())
                {
                    echo "<p class='dados'>";
                    echo "<br><b> Código: </b>".$linha['cd_funcionario'];
                    echo "<br><b> Nome: </b>".$linha['nm_funcionario'];
                    echo "<br><b> Cargo: </b>".$linha['ds_cargo'];
                    echo "<br><b> CPF: </b>".$linha['cpf_funcionario'];
                    echo "<br><b>RG: </b>".$linha['rg_funcionario'];
                    echo "<br><b>CEP: </b>".$linha['cep_funcionario'];
                    echo "<br><b> Endereço: </b>".$linha['ds_endereco'];
                    echo "<br><b>Celular: </b>".$linha['cel_funcionario'];
                    echo "<br><b>Email: </b>".$linha['em_funcionario'];
                    echo "<br>Foto:<br><img src=".$linha['img_funcionario']." width='120vh' style='border: 5px solid #6e214f'>";
                    echo "</p>";
        ?>
          <div class="btnOpcoes">
                <button class="buto" type="submit" id="btnEnviar" onclick="location.href='alterarFuncionario.php?codigo=<?php echo $linha['cd_funcionario'];?>'"> Alterar</button>
                <button class="buto" type="reset" onclick="location.href='excluirFuncionario.php?codigo=<?php echo $linha['cd_funcionario'];?>'"> Excluir</button>
