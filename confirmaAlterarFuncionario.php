...
include_once('conexao.php');
	try 
	{
		...
		$stmt = $con->prepare('UPDATE tb_funcionario SET nm_funcionario = :nome,
													 cpf_funcionario = :cpf,
													 rg_funcionario = :rg,
													 ds_endereco = :ende,
                           ds_cargo = :cargo,
...
<main class="main">
        ...
        <section class="twitter">
          <div class="containerDois"> 
              <h1 class="titulo">Funcionário de código <?php echo $cod; ?> alterado com sucesso!</h1>              
                <button class="btns" type="reset" onclick="javascript: location.href='consultaFuncionario.php'" style="width: 80%; margin-left: 10%;"> Voltar</button> 
          </div>
        </section>
      </main>
</body>
