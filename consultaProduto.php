...
<main class="main">
        ...
        <section class="twitter">
          <div class="containerDois">
              ...
              <div class="col-3">
                    <input class="effect-1" type="text" placeholder="Pesquisar nome do produto" id="user" name="nome" required>
            ...
            try
            {
                ...
                {
                    echo "<p class='dados'>";
                    echo "<br><b> Código: </b>".$linha['cd_produto'];
                    echo "<br><b> Nome: </b>".$linha['nm_produto'];
                    echo "<br><b> Quantidade: </b>".$linha['qnt_produto'];
                    echo "<br><b> Preço de compra: </b>".$linha['pc_produto'];
                    echo "<br><b> Preço de venda: </b>".$linha['pv_produto'];
                    echo "<br>Foto:<br><img src=".$linha['img_produto']." width='120vh' style='border: 5px solid #6e214f'>";
                    echo "</p>";
        ?>
          <div class="btnOpcoes">
                <button class="buto" type="submit" id="btnEnviar" onclick="location.href='alterarProduto.php?codigo=<?php echo $linha['cd_produto'];?>'"> Alterar</button>
                <button class="buto" type="reset" onclick="location.href='excluirProduto.php?codigo=<?php echo $linha['cd_produto'];?>'"> Excluir</button>
