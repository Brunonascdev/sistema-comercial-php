...
<main class="main">
        ...
        <section class="twitter">
          <div class="containerDois">
              <h1 class="titulo">Excluir funcionário</h1>
              <?php
               ...
               ?>
               <button class="buto" type="reset" onclick="javascript: location.href='confirmaExcluirFuncionario.php?codigo=<?php echo $cod;?>'"> Excluir</button>
