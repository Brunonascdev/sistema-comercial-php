...
<main class="main">
        ...
        <section class="twitter">
          <div class="containerDois">
              ...
              <div class="col-3">
                    <input class="effect-1" type="text" placeholder="Nome do Produto" id="user" name="nome" required>
                    <span class="focus-border"></span>
                </div>
                <div class="col-3">
                    <input class="effect-1" type="text" placeholder="Quantidade" id="user" name="quantidade" required>
                    <span class="focus-border"></span>
                </div>
                <div class="col-3">
                    <input class="effect-1" type="number" placeholder="Preço de Compra" id="pc" name="preçoCompra" required>
                    <span class="focus-border"></span>
                </div>
                <div class="col-3">
                    <input class="effect-1" type="number" placeholder="Preço de Venda" id="pv" name="preçoVenda" required>
                    <span class="focus-border"></span>
                </div>
                <div class="col-3">
      ...
      <?php
                if (!empty($_POST))
                {
                  ...
                  $stmt->bindParam(2,$qnt);
                  $stmt->bindParam(3,$pc);
                  $stmt->bindParam(4,$pv);
                  $stmt->bindParam(5,$caminhoIMG);
